...
public class Board implements BoardManager {
    ...
    private boolean trapCellsEnabled = true;
    ...
    public boolean isTrapCellsEnabled() {
        return trapCellsEnabled;
    }

    public void setTrapCellsEnabled(boolean enabled) {
        if (this.trapCellsEnabled == enabled)
            return;

        this.trapCellsEnabled = enabled;
    ...
    private void move(Marble marble, ArrayList<Cell> fullPath, boolean destroy) throws IllegalDestroyException {
        ...
        if(trapCellsEnabled && targetCell.isTrap()) {
